...
module RailsJwtAuth
  ...
  mattr_accessor :jwt_validate_ip
  self.jwt_validate_ip = false

  mattr_accessor :jwt_validate_user_agent
  self.jwt_validate_user_agent = false
